...
$(document).ready(function() {
    ...
    let text = "";
            ...
            var containerno = jsonObject["containerno"] == "yes" && jsonObject["containernofn"] == "yes" ?
                `${qrcontainerno} : ${details.container_no}${qrbarcodedelimiter}` :
                jsonObject["containerno"] == "yes" ? `${details.container_no}${qrbarcodedelimiter}` : '';
