    ...
    <form action="/updaterejectpending/{{$product_edit->id}}" method="post" enctype="multipart/form-data">
        ...
        <div class="headingfont form-row " style="padding-bottom:20px;padding-top:40px;">
            ...
            <div class="form-group col-md-3 {{$config['product_id_use'] == 'off' ? '' : 'hideField'}}">
                ...
                <input type="number" maxlength="100" name="product_id" id="product_id" min='0'
        ...
        <div class="headingfont form-row ">
            ...
            <div class="form-group col-md-3 {{$config['g_field1_use'] == 'on' ? '' : 'hideField'}}">
                ...
                value="{{ $config->global_static_field1 }}" class="required validate form-control form-control-sm" autocomplete="off"
